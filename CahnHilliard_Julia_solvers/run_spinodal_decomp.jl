...
#     writedlm(f, [Dates.format(date_time, "mm/dd/yyyy HH:MM:SS") "NMG_spinodal_decomp_smoothed_print" "Julia" "NMG" GridSize epsilon dt 1e5 max_it 1e4 pathname elapsed_time mem_allocated / 1e6], ",")
# end
...
ch_movie_from_file("$(pathname)phi.csv", t_out, 128; dtframes=200, filename="$(pathname)movie_jl", filetype="mp4", colorbar_type="default")